...
if __name__ == "__main__":
    ...
    opt.source = "data/exported_recordings/"
    opt.file_extension = ".zip"
    opt.path_to_metadata = "data/exported_recordings/info*.csv"
    opt.filter_key = "/Channel/State/actTNumber"
    opt.logging_level = "DEBUG"
